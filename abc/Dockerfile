...
ARG abc2midi_version=2020.08.09
...
ARG xml2abc_version=142
ARG abc2xml_version=228
...
ARG abc2svg_version=1.20.12

RUN apk add pango && npm i -g abc2svg@$abc2svg_version jszip && clean
