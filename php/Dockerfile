...
RUN php -r "copy('https://getcomposer.org/installer', 'composer-setup.php');" \
    ...
    && su-exec user composer global require localheinz/composer-normalize webuni/composer-yaml-plugin webuni/composer-neon-plugin \
    && clean
...
RUN for module in \
    ...
    && if [ "$version" = "5.6" ]; then modules="$modules php5-xdebug@community35"; fi \
